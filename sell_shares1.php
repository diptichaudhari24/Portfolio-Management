...
<form action="http://localhost/project/sellshares.php" name="register" method="post"  onSubmit="return checkout(this.form);">
<script langauge="javascript">
alert("SORRY you donnot have tose many shares");
</script>
<table cellpadding="0" cellspacing="0" style="width: 844px; height: 890px">
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" valign="top" class="style1 style5">SELL  SHARES </td>
		<td>&nbsp;</td>
		<td colspan="2">&nbsp;</td>
	...
	<tr>
		...
		<select name="compname" style="width: 124px">
			...
			$sql="select compname from presentshares order by(compname)";
			$res=mysql_query($sql,$link);
	...
	<tr>
		<td valign="top">&nbsp;</td>
		<td valign="top"><strong>Sell  Date</strong> </td>
		<td valign="top">
			<input class="style2" name="selldate" type="text" value="<?php echo date("d/m/Y"); ?>"/>		</td>
		<td valign="top">&nbsp;</td>
		<td valign="top">&nbsp;</td>
		<td colspan="2" valign="top">&nbsp;</td>
	...
	<tr>
		...
		<td valign="top"><input name="sell_shares" style="width: 129px; height: 30px" type="submit" value="SELL" /></td>
		<td valign="top">&nbsp;</td>
		<td valign="top">&nbsp;</td>
		<td valign="top">&nbsp;</td>
		<td colspan="2" valign="top">&nbsp;</td>
